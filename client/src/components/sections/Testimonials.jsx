...
const testimonials = [
  {
    ...
    rating: 5,
    quote: "AutoFleetPro has revolutionized how we manage our showroom. The analytics and real-time tracking features are game-changers."
  },
  {
    id: 2,
    name: "Sarah Chen",
  ...
  },
  {
    ...
    rating: 5,
    quote: "Since implementing AutoFleetPro, our sales have increased by 40%. The inventory management system is simply outstanding."
  }
];
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-text-primary/80 text-lg max-w-2xl mx-auto">
            Hear from our satisfied customers about their experience with AutoFleetPro
          </p>
        </motion.div>
