...
const contactInfo = [
  {
    ...
    title: "Email Us",
    content: "contact@autofleetpro.com",
    link: "mailto:contact@autofleetpro.com"
  },
  {
...
const socialLinks = [
  { icon: <LinkedIn />, url: "https://linkedin.com/company/autofleetpro" },
  { icon: <Twitter />, url: "https://twitter.com/autofleetpro" },
  { icon: <Facebook />, url: "https://facebook.com/autofleetpro" },
  { icon: <Instagram />, url: "https://instagram.com/autofleetpro" }
];
